# KoinPaymentCheckout-test-1.0.0-beta.1.podspec
Pod::Spec.new do |s|
  ...
  s.source = {
    :http   => 'https://koinlatam.github.io/koin-checkout-ios/releases-test/1.0.0-beta.1/KoinPaymentCheckout-1.0.0-beta.1.zip',
